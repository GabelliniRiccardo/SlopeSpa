 ...
 */
final class Version20190709163708 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE reservations (id INT NOT NULL, treatment_id INT NOT NULL, room_id INT NOT NULL, customer_id INT NOT NULL, spa_id INT NOT NULL, start_time DATE NOT NULL, end_time DATE NOT NULL, duration INT NOT NULL, price DOUBLE PRECISION NOT NULL, vat DOUBLE PRECISION NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('ALTER TABLE rooms ADD CONSTRAINT FK_7CA11A96DF3CB247 FOREIGN KEY (spa_id) REFERENCES SPAs (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
